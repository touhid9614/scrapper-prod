        ...
        entryPoints: [
            {
                ...
                url: 'https://www.liachryslerdodgejeepram.com/searchnew.aspx?Dealership=Lia%20Chrysler%20Jeep%20Dodge%20Ram',
                requiredParams: null,
            ...
            },
            {
                ...
                url: 'https://www.liachryslerdodgejeepram.com/searchused.aspx?Dealership=Lia%20Chrysler%20Jeep%20Dodge%20Ram',
                requiredParams: null,
                productType: ProductType.CAR,
                type: EntryPoint_Type.HTML,
            },
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: 'srp-results-count[^>]*>\\s<strong>(?<total_product>\\d*)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: "<a\\s*href='(?<next_page>[^']+)'\\s*class=\"stat\\-arrow\\-next\"\\s*",
                        active: true,
                    },
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 2,
                        value: 'https://www.liachryslerdodgejeepram.com',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '<div class="col-md-9 sidebar-oncanvas">|<div class="row srpDisclaimer"<take>1',
                        active: true,
                    },
                    {
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: 'hero-carousel__item--viewvehicle"\\s*href="https:\\/\\/www.larsenauto.com\\/(?<stock_type>used|new)',
                        active: true,
                    },
                ],
            },
